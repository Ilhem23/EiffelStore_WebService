...
public class EiffelCorpServer {
	...
	public static void main(String[] args) throws RemoteException, MalformedURLException {
		...
		Employee emp1= employeeService.addEmployee("ghada", "bensaid", "ghada5@gmail.com", "5 noisey le grand", "ghada23", "ghada23");
		...
		Employee emp4= employeeService.addEmployee("Ilhem", "Aissaoui", "ei_aissaoui@esi.dz", "5 impasse honore de balzac", "Ilhem23", "Ilhem23");
